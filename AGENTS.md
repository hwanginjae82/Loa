...
- Local previews must never connect to or write the shared production Supabase record. Only the published, non-local site may enable shared database access.
